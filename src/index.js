...
function isValidLinkedInUrl(url) {
  ...
  if (trimmed.length === 0) return true; // Empty is valid (optional field)
  try {
    const parsedUrl = new URL(trimmed);
    // Must be https and from linkedin.com domain
    if (parsedUrl.protocol !== 'https:') return false;
    if (!parsedUrl.hostname.endsWith('linkedin.com')) return false;
    return true;
  } catch (e) {
    return false;
  }
...
let users = [
    ...
    {id: 2, firstName: 'Bob', lastName: 'Johnson', role: 'user', email: 'bob@example.com', gender: 'male', phoneNumber: '+1987654321', linkedinUrl: 'https://www.linkedin.com/in/bobjohnson'},
    {id: 3, firstName: 'Charlie', lastName: 'Brown', role: 'user', email: 'charlie@example.com', gender: 'male'},
    {id: 4, firstName: 'David', lastName: 'Williams', role: 'admin', email: 'david@example.com', gender: 'male', phoneNumber: '+1555123456', linkedinUrl: 'https://www.linkedin.com/in/davidwilliams'},
    ...
    {id: 7, firstName: 'Grace', lastName: 'Garcia', role: 'user', email: 'grace@example.com', gender: 'female', phoneNumber: '+1777888999', linkedinUrl: 'https://www.linkedin.com/in/gracegarcia'},
...
app.put('/api/users/:id', (req, res) => {
    ...
    if (linkedinUrl !== undefined && linkedinUrl !== null && !isValidLinkedInUrl(linkedinUrl)) {
        return res.status(400).json({error: 'Invalid LinkedIn URL'});
    }
    ...
    if (linkedinUrl !== undefined) users[index].linkedinUrl = linkedinUrl && linkedinUrl.trim() ? linkedinUrl.trim() : null;
    res.json({
