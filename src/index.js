...
let users = [
    ...
    {id: 4, firstName: 'David', lastName: 'Williams', role: 'admin', email: 'david@example.com', gender: 'male', phoneNumber: '+1555123456', linkedinUrl: 'https://linkedin.com/in/david-williams'},
...
app.put('/api/users/:id', (req, res) => {
    ...
    if (linkedinUrl !== undefined && linkedinUrl !== null && !isValidUrl(linkedinUrl)) {
        return res.status(400).json({error: 'Invalid LinkedIn URL'});
    }
